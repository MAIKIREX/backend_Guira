            ...
            columns: [
              // Columna Izquierda (Origen y Fechas)
              {
                ...
                stack: [
                  ...
                  {
                    text: `${amountOrigin} ${originCurrency.toUpperCase()}`,
                    style: 'value',
                  },
                  { text: 'Tarifa (Fee):', style: 'label' },
                  {
                    text: `${fee} ${originCurrency.toUpperCase()}`,
                    style: 'value',
                  },
                  { text: 'Tipo de Cambio Aplicado:', style: 'label' },
                  {
                    text: toDisplayValue(order.exchange_rate_applied),
                    style: 'value',
                  },
              ...
              // Columna Derecha
              {
                ...
                stack: [
                  ...
                  {
                    text: toDisplayValue(supplier?.name ?? 'No asignado'),
                    style: 'value',
                  },
                  { text: 'Propósito:', style: 'label' },
                  {
                    text: toDisplayValue(
                      order.business_purpose ??
                        readString(metadata, 'payment_reason'),
                    ),
                    style: 'value',
                  },
                  ...
                  {
                    text: toDisplayValue(
                      readString(metadata, 'delivery_method'),
                    ),
                    style: 'value',
                  },
